...
public class JwtService {
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) {
        ...
        // Le sujet du token est l'email (voir buildToken) — comparer au même identifiant,
        // pas à User.getUsername() qui renvoie le pseudo depuis l'ajout du champ username.
        String expected = (userDetails instanceof User user) ? user.getEmail() : userDetails.getUsername();
